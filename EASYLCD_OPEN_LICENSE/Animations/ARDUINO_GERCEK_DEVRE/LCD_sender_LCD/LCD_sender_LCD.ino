// ******* Arduino ve EASYLCD software serial ***************  
...
//  }
 ...
 //  örnek cümleler  if sayac=51 then hserout ["LCDEW 5-",$0E,$11,$10,$0E,$01,$15,$0E,$04]:goto sonkal   ; Ş  °
 //    "LCDNC 3-",$0E,$10,$10,$0E,$01,$05,$1E,$04]
  ...
  void loop() { // run over and over                                             
      ...
      if ( a == 2 ) {a=a+1; stringThree= "LCDEW 5-";mySerial.print(stringThree);mySerial.write(0x0E);mySerial.write(0x11);mySerial.write(0x10);mySerial.write(0x10);mySerial.write(0x11);mySerial.write(0x0E);mySerial.write(0x04);mySerial.write(0x01); delay(1000);}    // smiley yerine hex değerlerini koy. ****************************
      if ( a == 3 ) {a=a+1; stringThree= "LCDNC 3-" ; mySerial.print(stringThree); mySerial.write(0x0E);mySerial.write(0x11);mySerial.write(0x10);mySerial.write(0x0E);mySerial.write(0x01);mySerial.write(0x15);mySerial.write(0x0E);mySerial.write(0x04);delay(1000);};
      if ( a == 4 ) {a=a+1; stringThree= "LCDWR 1,1-A" ; mySerial.print(stringThree); mySerial.write(0x03);delay(10);stringThree= "LCDWR 1,3-IK";EkranYaz();delay(1500);};
     ...
     if ( a == 8) { YAZI="4. SATIR" ; stringThree= "LCDWR 4,1-"+ YAZI +" ==> "+ a ;EkranYaz();  }                                                                                                                                // alt satırda 14 yazıldığında alıcıdan dolayı problem yapıyor
      ...
      if ( a == 20) { stringThree= "LCDCH" ;EkranYaz();delay(1000);  }
      if ( a == 22) { stringThree= "LCDCB" ;EkranYaz();  }
      
      if ( a == 21) { YAZI="CUR SHIFT L<=" ; stringThree= "LCDWR 1,1-"+ YAZI ;EkranYaz();  }
  ...
  //    if ( a == 44) { YAZI="BACKLIGHT  %90  " ; stringThree= "LCDWR 1,1-"+ YAZI ;EkranYaz();  }
   //   if ( a == 45) { stringThree= "LCDBL 9" ;EkranYaz();  }      
    ...
    if ( a == 43) { stringThree= "LCDCH" ;EkranYaz();  }      

     if ( a == 44) { stringThree= "LCDSC 5,3-" ;EkranYaz();  }   // Epromdaki 3. karakteri yeni karakter alanına kopyalar  SWAP CHARACTER(SC)
      if ( a == 45 ) {a=a+1; stringThree= "LCDWR 1,1-A" ; mySerial.print(stringThree); mySerial.write(0x03);delay(100);stringThree= "LCDWR 1,3-IK          ";mySerial.print(stringThree);delay(2000);};
      if ( a == 46) { YAZI=" READ CH. EPROM " ; stringThree= "LCDWR 2,1-"+ YAZI ;EkranYaz();  }
      if ( a == 47) { stringThree= "LCDER" ;EkranYaz(); delay(24000); } 
      if ( a == 48) { YAZI="READ 1 CHARACTER" ; stringThree= "LCDWR 1,1-"+ YAZI ;EkranYaz();delay(1000);  }
     if ( a == 49) { stringThree= "LCDRC 1,14-" ;EkranYaz(); delay(1000);  } 
